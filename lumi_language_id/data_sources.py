...
def twitter_gen():
    with open(data_file('TweetLID_corpusV2/tweetlid-test-tweets.tsv')) as twitter_file:
...
def wiki_gen():
    with open(data_file('WiLI/x_test.txt')) as texts_file:
        with open(data_file('WiLI/y_test.txt')) as labels_file:
...
def tatoeba_gen():
    with open(data_file('Tatoeba/tatoeba_short_text.txt')) as tatoeba_file:
